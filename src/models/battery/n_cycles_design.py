...
def battery_cycle_life(DOD: float, C_rate_avg: float, c_charge: float) -> float:
    ...
    """
    a_n = -5986.8421   # estimated parameter for DoD effect
    b_n = 11776.3158   # estimated parameter for DoD effect
    c_n = 1.1          # estimated exponent for discharge rate penalty
    d_n = 1.2          # estimated exponent for charging rate penalty
